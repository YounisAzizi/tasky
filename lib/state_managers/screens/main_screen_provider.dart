...
class MainScreenProvider extends ChangeNotifier {
  ...
  Future<void> fetchListTodos(int page, WidgetRef ref,BuildContext context) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        print('success');
        final List serverItems = json.decode(response.body);
      final newTodos =
  ...
  //       url: 'https://todo.iraqsapp.com/todos?page=1',
  //       headers: {
  //         'Content-Type': 'application/json',
  //         'Authorization': 'Bearer ${SharedPrefs.getStoreToken()}',
  //       },
